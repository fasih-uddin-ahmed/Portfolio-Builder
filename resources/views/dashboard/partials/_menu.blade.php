<div class="list-group">
    <a class="list-group-item list-group-item-action {{request()->is('*profile*') ? 'active': ''}}" href="{{route('profile_view', auth()->user()->id)}}"><i class="fa fa-home fa-fw" aria-hidden="true"></i>&nbsp; Profile</a>
